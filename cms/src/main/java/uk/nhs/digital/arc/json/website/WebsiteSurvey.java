...
@JsonTypeName("website_survey")
public class WebsiteSurvey extends PublicationBodyItem {
    ...
    public WebsiteSurvey(@JsonProperty(value = "date_REQ", required = true) String dateReq,
